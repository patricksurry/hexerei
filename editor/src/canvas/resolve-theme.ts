...
export function resolveCanvasTheme(): CanvasTheme {
  ...
  return {
    ...
    gridGlow: get('--canvas-grid-glow') || 'rgba(0, 140, 180, 0.3)',
    ...
    labelPillColor: get('--canvas-label-pill') || 'rgba(10, 14, 20, 0.55)',
    ...
    featureLabelPillColor: get('--canvas-feature-pill') || 'rgba(10, 14, 20, 0.65)',
