...
export function resolveCanvasTheme(): CanvasTheme {
  ...
  return {
    ...
    labelPillColor: get('--canvas-label-pill') || 'rgba(10, 14, 20, 0.14)',
    ...
    hexLabelScale: getNum('--canvas-hex-label-scale', 0.22),
    hexLabelOffset: getNum('--canvas-hex-label-offset', 0.55),
