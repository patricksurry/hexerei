...
const ORIENTATIONS: OptionPickerOption<Orientation>[] = [
  {
    id: 'flat-down',
    label: 'Flat Down',
    svg: (
      <svg viewBox="5 7.3 13.5 7.5">
        ...
        <polygon
          points="18,10 16.75,12.17 14.25,12.17 13,10 14.25,7.83 16.75,7.83"
          opacity="0.45"
        />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="5 9.2 13.5 7.5">
        ...
        <polygon
          points="18,14 16.75,16.17 14.25,16.17 13,14 14.25,11.83 16.75,11.83"
          opacity="0.45"
        />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="7.3 5 7.5 13.5">
        ...
        <polygon
          points="12.17,16.75 10,18 7.83,16.75 7.83,14.25 10,13 12.17,14.25"
          opacity="0.45"
        />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="9.2 5 7.5 13.5">
        ...
        <polygon
          points="16.17,16.75 14,18 11.83,16.75 11.83,14.25 14,13 16.17,14.25"
          opacity="0.45"
        />
      </svg>
    ),
...
export const OrientationPicker = ({ value, onChange }: OrientationPickerProps) => (
  <OptionPicker
    ...
    onChange={onChange}
    className="orientation-picker"
    buttonClassName="orientation-btn"
  />
);
