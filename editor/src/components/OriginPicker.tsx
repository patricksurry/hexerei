...
export const OriginPicker = ({ value, onChange }: OriginPickerProps) => (
  <div className="origin-picker">
    {ORIGINS.map(opt => (
      <button
        key={opt.id}
        className={`origin-btn ${value === opt.id ? 'active' : ''}`}
        title={opt.id}
